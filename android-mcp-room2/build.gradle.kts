...
android {
    namespace = "top.cyclops.mcp.room.plugin.room"
    compileSdk = 36
...
mavenPublishing {
    ...
    coordinates("top.cyclops", "android-mcp-room2", project.version.toString())

    pom {
        name = project.name
        description = "Room 2.x adapter helpers for Android MCP Room provider integration"
